...
def step2():
    ...
    try:
        ...
        return np.zeros((13,)), 0, 0, np.zeros((6,)), 100, 0 , 0, 0, 0, 0
...
if __name__ == "__main__":
    actor_checkpoint = "/home/robot_ws/src/code/hec/python/checkpoints/pose/actor_checkpoint"
    ...
    while not rospy.is_shutdown():
        ...
        if i==0 and j==0:
            ...
            if state[0] == 0 and state[1] == 0 and state[2] == 0 and state[3] == 0 and state[4] == 0 and state[5] == 0:
                continue
            if state[0] == next_state[0] and state[1] == next_state[1] and state[2] == next_state[2] and state[3] == next_state[3] and state[4] == next_state[4] and state[5] == next_state[5] and state[6] == next_state[6] and state[7] == next_state[7] and state[8] == next_state[8] and state[9] == next_state[9] and state[10] == next_state[10] and state[11] == next_state[11] and state[12] == next_state[12]:
                continue
            j = 1
        ...
        if next_state[0] == 0 and next_state[1] == 0 and next_state[2] == 0 and next_state[3] == 0 and next_state[4] == 0 and next_state[5] == 0 and next_state[6] == 0 and next_state[7] == 0 and next_state[8] == 0 and next_state[9] == 0 and next_state[10] == 0 and next_state[11] == 0 and next_state[12] == 0:
            continue
